...
export default function Hero(){
    return (
        <div>
          <div 
            className="bg-cover bg-center h-64 md:h-96 bg-opacity-75"
            style={{ 
              backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.2)), url(${backgroundImage})` 
            }}
          >
            <div className="text-gray-100container mx-auto h-full px-4 md:px-0 flex flex-col justify-center items-center text-white"> 
              <h1 className="text-shadow-md text-2xl md:text-4xl text-center font-bold mb-4">
